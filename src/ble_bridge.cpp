...
#else
  // Arduino-ESP32's NimBLE wrapper does not expose a public "clear all bonds"
  // API here. Keep unpair as a no-op instead of breaking the build.
  Serial.println("[ble] unpair requested; NimBLE bond clearing is not exposed");
#endif
}
